...
namespace ZapAgenda_api_aspnet.repositories.interfaces
{
    ...
    {
        Task<Result<Usuario>> CreateAsync(CreateUsuarioDto dto, Guid IdEmpresa);
        ...
        Task<Result<Usuario>> UpdateSenhaByNomeUsuarioAsync(Guid idEmpresa, string nomeUsuario, string novaSenha); // <-- Adicionado
